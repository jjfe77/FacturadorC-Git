...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBoxIdEmpleado = (gcnew System::Windows::Forms::TextBox());
			...
			this->buttonClientes->Click += gcnew System::EventHandler(this, &Empleados::buttonClientes_Click);
			// 
			// buttonProveedores
			// 
			...
			this->buttonProveedores->Click += gcnew System::EventHandler(this, &Empleados::buttonProveedores_Click);
			// 
			// buttonCargar
			// 
			...
			this->buttonCargar->Click += gcnew System::EventHandler(this, &Empleados::buttonCargar_Click);
			// 
			// buttonSalir
			// 
			...
			this->buttonSalir->Click += gcnew System::EventHandler(this, &Empleados::buttonSalir_Click);
			// 
			// dataGridView1
			// 
			...
			this->textBoxIdEmpleado->Location = System::Drawing::Point(295, 117);
			this->textBoxIdEmpleado->Name = L"textBoxIdEmpleado";
			this->textBoxIdEmpleado->Size = System::Drawing::Size(337, 20);
			this->textBoxIdEmpleado->TabIndex = 81;
			// 
			// label1
			// 
			...
			this->label1->Text = L"Id Empleado";
			// 
			// buttonEliminar
			// 
			...
			this->buttonEliminar->Click += gcnew System::EventHandler(this, &Empleados::buttonEliminar_Click);
			// 
			// buttonEditar
			// 
			...
			this->buttonEditar->Click += gcnew System::EventHandler(this, &Empleados::buttonEditar_Click);
			// 
			// buttonAgregar
			// 
			...
			this->buttonAgregar->Click += gcnew System::EventHandler(this, &Empleados::buttonAgregar_Click);
			// 
			// buttonFacturacion
			// 
			...
			this->buttonFacturacion->Click += gcnew System::EventHandler(this, &Empleados::buttonFacturacion_Click);
			// 
			// buttonEmpleados
			// 
			...
			this->buttonStock->Click += gcnew System::EventHandler(this, &Empleados::buttonStock_Click);
			// 
			// Empleados
			// 
...
private: System::Void buttonCargar_Click(System::Object^ sender, System::EventArgs^ e) {
	if (dataGridView1->SelectedRows->Count > 0) {
		...
		textBoxIdEmpleado->Text = Convert::ToString(fila->Cells[0]->Value);
...
private: System::Void buttonEditar_Click(System::Object^ sender, System::EventArgs^ e) {
	if (dataGridView1->SelectedRows->Count > 0) {
		...
		// Modificar los valores de la fila con los datos de los TextBox
		fila->Cells[0]->Value = textBoxIdEmpleado->Text;
